...
insert into usuario(status,login,senha) values (0,'asd','$2a$10$GfPrrBdtAiejRH2AuXUClu/5/nJMpctmpy9fDhk9P3naidE4e.0B.');


insert into users_roles(user_id,role_id) values((select IDUsuario from USUARIO where login = 'asd'),(select id from role where name = 'ALUNO'));
