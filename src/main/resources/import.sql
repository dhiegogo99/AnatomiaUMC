...
insert into UserUMC(status,login,Password) values (1,'456','$2a$10$GfPrrBdtAiejRH2AuXUClu/5/nJMpctmpy9fDhk9P3naidE4e.0B.');
insert into UserUMC(status,login,Password) values (1,'789','$2a$10$GfPrrBdtAiejRH2AuXUClu/5/nJMpctmpy9fDhk9P3naidE4e.0B.');
